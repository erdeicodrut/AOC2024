...
void main(List<String> args) {
  ...
  final paths = getLowestCost();

  final points = paths.fold(<Point<int>>{}, (acc, e) => {...acc, ...e.$2});

  // print(points);
  print(points.length + 1);
}

List<(int, List<Point<int>>)> getLowestCost() {
  int lowestCost = 2e9.toInt();
  int currentCost = 0;
  List<(int, List<Point<int>>)> answers = [];
  while (nextPositions.isNotEmpty && currentCost <= lowestCost) {
